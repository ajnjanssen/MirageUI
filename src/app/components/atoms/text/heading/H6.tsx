...
interface H6Props extends TextProps {
  children: React.ReactNode;
}

/**
 * H6 component renders an H6 heading with optional text properties.
 *
 * @param {Object} props - The properties object.
 * @param {React.ReactNode} props.children - The content to be rendered inside the H6 element.
