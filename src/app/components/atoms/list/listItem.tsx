...
/**
 * ListItem component renders a list item with optional text properties.
 *
 * @param {Object} props - The properties object.
 * @param {React.ReactNode} props.children - The content to be rendered inside the list item element.
 ...
 * @param {keyof typeof BorderColor} [props.borderColor] - The border color.
 * @param {keyof typeof BorderWidth} [props.borderWidth] - The border width.
 * @param {keyof typeof BorderRadius} [props.borderRadius] - The border radius.
 * @param {keyof typeof BorderStyle} [props.borderStyle] - The border style.
